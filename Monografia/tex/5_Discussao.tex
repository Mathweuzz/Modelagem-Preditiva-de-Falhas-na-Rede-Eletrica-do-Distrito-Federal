...
\begin{enumerate}
    \item \textbf{Engenharia de atributos temporais:} A construção manual de 40 \textit{features} --- incluindo defasagens de 1 a 7 dias, médias móveis exponenciais e codificações harmônicas --- forneceu ao XGBoost informação temporal explícita. A ablação mostrou, porém, que essa contribuição não é uniforme: histórico + calendário superou o conjunto completo no teste pós-hoc, enquanto o grupo climático não apresentou ganho incremental.
