...
Engenharia de Atributos & 40 \textit{features} & Mesmas 40 \textit{features} + janela de 14 dias \\
\bottomrule
\end{tabular}
\normalsize
\end{center}
...
Uma reflexão metodológica importante emerge da comparação entre o XGBoost e as redes recorrentes: \textbf{todos os modelos receberam as mesmas 40 \textit{features} construídas com conhecimento de domínio}. A diferença é que Bi-LSTM e Bi-GRU processam essas variáveis em janelas sequenciais de 14 dias. A proximidade entre XGBoost e Bi-LSTM em $h=1$ mostra que as duas arquiteturas alcançaram desempenho semelhante sob essa representação comum, mas não demonstra que a rede substitua ou dispense a engenharia manual de atributos.
