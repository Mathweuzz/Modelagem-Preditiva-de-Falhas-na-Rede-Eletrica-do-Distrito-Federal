...
Script complementar (\texttt{Fonte/src/models/plot\_multihorizonte.py}) que regenera os gráficos de desempenho por horizonte (MAE e RMSE) a partir do arquivo \texttt{previsao\_multihorizonte\_metricas.csv}, sem necessidade de re-executar os modelos. Produz três figuras: comparação de MAE por horizonte com anotações, comparação de RMSE e painel duplo MAE/RMSE. O código integral deste módulo está disponível no repositório do projeto.
