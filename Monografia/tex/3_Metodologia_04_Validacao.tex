...
\input{tex/3_Metodologia_05_Robustez}
...
\caption{Invariantes verificadas pela suíte automatizada}\label{qua:invariantes_testes}\\
\toprule
...
\input{tex/3_Metodologia_06_Interface}
...
Com esse delineamento, ficam estabelecidos os critérios de obtenção e preparação dos dados, treinamento dos modelos, avaliação temporal, análise de robustez e controle da reprodutibilidade. O próximo capítulo aborda os resultados obtidos.
